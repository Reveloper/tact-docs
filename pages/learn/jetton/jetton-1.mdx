...
implemented with FunC language and support in libraries in various languages. Some of them, you can find and research [here](https://ton.org/docs/develop/dapps/defi/tokens).
...
<Callout type="warning">
Note, that `jetton.tact` is used for learning goals and was not thoroughly tested.
</Callout>
