...
```tact filename="sources/jetton.tact" copy
...
* Input your deployment Testnet wallet seed in `tact-jetton/sources/jetton.deploy.ts`:
```ts filename="sources/jetton.deploy.ts"
